...
%   four-connected boundary.  RC is a P-by-2 matrix, each row of which
%   contains the row and column coordinates of a boundary pixel.
%   BOUND2FOUR inserts new boundary pixels wherever there is a diagonal
%   connection.
%
