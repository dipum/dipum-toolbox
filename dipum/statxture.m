...
%   T = STATXURE(F,SCALE) computes six measures of texture from an image
%   (region) F. Parameter SCALE is a 6-dim row vector whose elements
%   multiply the 6 corresponding elements of T for scaling purposes. If
%   SCALE is not provided it defaults to all 1s. The output T is a
%   6-by-1 vector with the following elements:
